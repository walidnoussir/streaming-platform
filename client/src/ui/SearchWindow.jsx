function SearchWindow() {
  return (
    <div className="fixed w-screen top-18 left-0 bg-white border border-gray-200 rounded-lg md:w-[48rem] md:left-90 md:top-16 z-50 dark:bg-dark-2 dark:border-slate-950">
